// ref: https://medium.com/flutterpub/flutter-and-google-maps-2b4e332e24ec
...
void main() {
  runApp(MaterialApp(
    home: Scaffold(
      ...
      body: AnotherMapsDemo(),
    ),
  ));
}

class AnotherMapsDemo extends StatefulWidget {
  @override
  State createState() => AnotherMapsDemoState();
}

class AnotherMapsDemoState extends State<AnotherMapsDemo> {
